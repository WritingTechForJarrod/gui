kb_font_size = 200
kb_shape = (3,1) # row, col
kb_version = 6 # 1=dynamic keyboard, 2=static position, time-based selection, 3=max spacing layout, time-based selection
