...
class Application(Frame):
	def __init__(self, master=None, screen_size=(1080, 720)):
		...
		# Temporary location, initializes server.
	...
	def _draw_periodic(self):
		...
		input_device = (self.last_mouse,self.last_eye,self.last_face)[settings.input_device]
		if settings.keep_coordinates_log == 1:
				coordinates_log.write(str(input_device[0]) + "," + str(input_device[1]) + "/n")
		...
		elif input_device is self.last_face:
			try:
...
if __name__ == '__main__':
	...
	'''import os
	import subprocess  
	os.chdir('C:/Users/alexb/OneDrive/Documents/UBC_Undergrad/4th_Year/Winter/ELEC_493/Code/vision/bin')
	subprocess.Popen([r'facial_detection.exe'])

	os.chdir('C:/Users/alexb/OneDrive/Documents/UBC_Undergrad/4th_Year/Winter/ELEC_493/Code/gui/src')'''
